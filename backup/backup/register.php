																...
																<div class="row">
																	...
																	<div class="col-md-4">
																		<select class="form-control" name="bulan" required>
																			<option value="" disabled hidden selected>Mon</option>
...
?>
                                        					...
                                        					<div class="form-group">
																...
																<textarea class="form-control" rows="6" name="alamat" required>Masukan alamat.........</textarea>
															</div>
                                        					<div class="form-group">
																<label for="exampleInputnumber">Nomor Handphone <i class="text-danger">*</i></label>
																<input type="number" class="form-control" name="no_hp" min="0" id="exampleInputnumber" placeholder="masukan nomor hp" required>
															</div>
														</div>
													</div>
												</div>
														...
														<div class="my-3">
															<div class="row ">
																<div class="col-lg-4 col-md-3 col-sm-4 col-xs-4 pl-1 pr-1 m-t-5 m-b-5">
                                                    				<input type="file" class="dropify" data-max-file-size="4M" name="foto_ktp" />
                                                     				<div class="memmbername">KTP</div>
																</div>
																<div class="col-lg-4 col-md-3 col-sm-4 col-xs-4 pl-1 pr-1 m-t-5 m-b-5">
																	<input type="file" class="dropify" data-max-file-size="4M" name="foto_selfie" required/>
                                            	...
                                            	<div class="list-group-item py-4" data-acc-step>
													...
													<div data-acc-content>
														<div class="my-3">
															<div class="col-lg-4 col-md-3 col-sm-4 col-xs-4 pl-1 pr-1 m-t-5 m-b-5">
                                                    			<input type="file" class="dropify" data-max-file-size="1M" name="bukti_bayar" required />

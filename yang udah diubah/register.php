    ...
    $('#step-4').ready(function(){
      $("#step-4 .float-right").hide();
          ...
          if(userId == ""){
            ...
            $.ajax({
              ...
              success : function(res){
                if (res == 0){
                  $("#error_user").html(`<p class="text-success">User ID Ditemukan</p>`);
                }
                else if (res == 1){
                  $("#error_user").html(`<p class="text-danger">User ID tidak ada, periksa kembali User ID</p>`);
                  $("#step-4 .float-right").hide();
                }
              }
            });
        ...
        $('#id-transaksi').keyup(()=> {
          ...
          if(userId == "" && idTransaksi == ""){
            $('#error_transaksi').html("");
            $("#step-4 .float-right").hide();
            ...
            $.ajax({
              ...
              success : function(res){
                if (res == 0){
                  $('#error_transaksi').html(`<p class="text-danger">ID Transaksi sudah pernah digunakan</p>`);
                  $('#step-4 .float-right').hide();
                }
                else if (res == 1){
                  $('#error_transaksi').html(`<p class="text-danger">ID Transaksi sudah kadaluarsa</p>`);
                  $('#step-4 .float-right').hide();
                }
                else if (res == 2){
                  $('#error_transaksi').html(`<p class="text-success">ID Transaksi bisa digunakan</p>`);
                  $('#step-4 .float-right').show();
                }
                else if (res == 3){
                  $('#error_transaksi').html(`<p class="text-danger">ID Transaksi Tidak Ditemukan</p>`);
                  $('#step-4 .float-right').hide();
                }
              }
            });

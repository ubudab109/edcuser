								...
								<div class="card">
									...
									<div class="card-footer text-right">
										<h4 class="text-left" style="font-weight:bold;">
											Saat Anda tutup akun maka akun anda......
										</h4>
										<form method="post" action="index-menu-profile-page-aksi_tutup_akun.html">
										<input type="hidden" value="<?= $_SESSION['user_id']; ?>" id="id_user" name="user_id">
										<button type="submit" class="btn btn-danger tutup">Tutup Akun</button>
										</form>
									</div>
							</div>
							</div>
